...
const STATIC_ASSETS = [
  ...
  "./assets/library-guides/beijing-alpacas.png",
  "./assets/library-guides/cornucopia.png",
  "./assets/library-guides/ignition.png",
  "./assets/library-guides/pwaa-pwaa-revolution.png",
  "./assets/library-guides/pwaaprep.png",
  "./assets/library-guides/ready-scholar-one.png",
  ...
  "./assets/campus-2d/audio/alpaca-campus-lofi-loop-3min-less-bass.mp3",
