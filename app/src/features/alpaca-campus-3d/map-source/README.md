...
For now, room topology, doors, NPCs, runtime objects, collisions, and interaction values still come from `app/src/features/campus-shared/data/rooms.js`. Decorative GLB objects still come from `app/src/features/alpaca-campus-3d/environment-assets.ts`.
