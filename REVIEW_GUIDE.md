...
- `build-case-controller.js`: Debate Lab / Build Case experience construction,
  topic selection, spinner timers, side assignment, suggestion rounds, NPG
  reveal timers, scoring, and rendering.
